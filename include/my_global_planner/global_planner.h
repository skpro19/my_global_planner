...
namespace global_planner {
    ...
    class GlobalPlanner : public nav_core::BaseGlobalPlanner {
        ...
        private: 
            ...
            rrt_star_cell* get_closest_cell(const Point &nxt_pt, int dis_r);
            void publish_marker_point(const Point &pt, int flag, int duration);
            bool is_point_reachable(const Point &p1, const Point &p2, int dis);
            bool check_cell_neighbour(const Point &pt, int margin_sz = 4);
